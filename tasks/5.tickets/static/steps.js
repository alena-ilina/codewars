...
(function () {
  ...
  const nextTaskButton = `<a class="button _nextTask" id="nextTask" href="../6.pizza/index.html" onclick"localStorage.clear()"> Ещё бы!</a>`
  ...
  if (bugsCurrentStep === '12') { content = step12Elements; }
