...
describe('Считаем стоимость билетов', () => {
  ...
  it('Выбрано длительная гроза и самолет с широкими креслами', () => {
    chai.expect(getPriceTicket(initialPrice, "Длительная гроза", "Самолет с широкими креслами")).to.equal('Самолет промок. Цена билета увеличена на 20%. За комфорт надо платить. Цена билета увеличена на 7%. Итого цена билета:' + initialPrice * 1.27)
  });

  it('Выбрано лето, солнце и рейс с питанием', () => {
    chai.expect(getPriceTicket(initialPrice, "Лето, солнце", "Рейс с питанием")).to.equal('Все хотят в отпуск. Цена билета увеличена на 40%. Еда стоит денег. Цена билета увеличена на 5%. Итого цена билета:' + initialPrice * 1.45)
  });
